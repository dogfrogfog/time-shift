      ...
      <Combobox value={selected} onChange={handleSelect}>
        <div className="relative mt-1">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
            afterLeave={() => setQuery("")}>
            <Combobox.Options className="!outline-none box-shadow absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
